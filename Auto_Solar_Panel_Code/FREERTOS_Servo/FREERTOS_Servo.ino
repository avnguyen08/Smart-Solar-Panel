...
//Task Handles
static TaskHandle_t move_servos = NULL;
...
void move_my_servos(void *parameter) {
  while(1) {
...
void setup() {
  ...
  vTaskDelay(1500);
  xTaskCreatePinnedToCore(move_my_servos, "moves servos", 5024, NULL, 1, &move_servos, app_cpu);
  vTaskDelay(1500);
  vTaskDelete(NULL);
}
